...
impl IAVIPersistFile_Vtbl {
    pub const fn new<Identity: IAVIPersistFile_Impl, const OFFSET: isize>() -> Self {
        unsafe extern "system" fn Reserved1<Identity: IAVIPersistFile_Impl, const OFFSET: isize>(
        ...
        Self {
            base__: IPersistFile_Vtbl::new::<Identity, OFFSET>(),
...
impl IPersistFile_Vtbl {
    pub const fn new<Identity: IPersistFile_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn Load<Identity: IPersistFile_Impl, const OFFSET: isize>(
            this: *mut core::ffi::c_void,
            pszfilename: windows_core::PCWSTR,
            dwmode: STGM,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                IPersistFile_Impl::Load(
                    this,
                    core::mem::transmute(&pszfilename),
                    core::mem::transmute_copy(&dwmode),
                )
                .into()
            }
        }
